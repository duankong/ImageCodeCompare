...
from utils.CompressConfig import format_adress, tuple_codes
...
from config import args_lossy_compress_config, show_and_recode_compress_args
...
def f(param, codec, image, width, height, temp_folder, subsampling):
    ...
    stats = compute_metrics(LOGGER, source_yuv, decoded_yuv, width, height, temp_folder, subsampling)
