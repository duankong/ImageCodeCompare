...
"""
---------------------------------------------------------------------
00_00 compress in lossy/lossless model 8bit/16bit  有损无损 8bit/16bit
---------------------------------------------------------------------
"""


def args_image_compress_config():
    ...
    parser.add_argument('-wd', '--work_dir', default="/code/runs/", type=str,
                        help='the work directory in container (default = "/code/runs/")')
    parser.add_argument('-mc', '--only_perform_missing_encodes', type=boolean_string, choices=[True, False],
...
def args_compress_video_config():
    ...
    parser.add_argument('-w', '--work_dir', default="/code/runs/", type=str,
